...
const Toggle = class {
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.checked = !this.checked;
      (0,_haptic_683b3b3c_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    }
  }
  ...
  render() {
    ...
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_3__.e)(true, el, name, checked ? value : '', disabled);
    return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.H, {
      ...
      htmlFor: inputId
    }, labelText), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("input", {
      type: "checkbox",
      role: "switch",
      "aria-checked": `${checked}`,
      disabled: disabled,
