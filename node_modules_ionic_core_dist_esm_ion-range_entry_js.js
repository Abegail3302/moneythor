...
const Range = class {
  constructor(hostRef) {
    ...
    this.ionKnobMoveStart = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.e)(this, "ionKnobMoveStart", 7);
    this.ionKnobMoveEnd = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.e)(this, "ionKnobMoveEnd", 7);
    this.didLoad = false;
    this.noUpdate = false;
    this.hasFocus = false;
    ...
    this.clampBounds = value => {
      return (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(this.min, value, this.max);
    };
    ...
    this.setupGesture = /*#__PURE__*/(0,C_Users_ACER_moneythor_firebase_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
    ...
    this.handleKeyboard = (knob, isIncrease) => {
      ...
      if (knob === 'A') {
        this.ratioA = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioA + step, 1);
      } else {
        this.ratioB = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, this.ratioB + step, 1);
      }
  ...
  debounceChanged() {
    this.ionChange = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.h)(this.ionChange, this.debounce);
  }
  ...
  connectedCallback() {
    ...
    this.contentEl = (0,_index_8bf9b0cd_js__WEBPACK_IMPORTED_MODULE_3__.f)(this.el);
  }
  ...
  onStart(detail) {
    ...
    if (contentEl) {
      this.initialContentScrollY = (0,_index_8bf9b0cd_js__WEBPACK_IMPORTED_MODULE_3__.d)(contentEl);
    }

    const rect = this.rect = this.rangeSlider.getBoundingClientRect();
    const currentX = detail.currentX; // figure out which knob they started closer to

    let ratio = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (currentX - rect.left) / rect.width, 1);

    if ((0,_dir_e8b767a8_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el)) {
      ratio = 1 - ratio;
    }
  ...
  onEnd(detail) {
    ...
    if (contentEl) {
      (0,_index_8bf9b0cd_js__WEBPACK_IMPORTED_MODULE_3__.r)(contentEl, initialContentScrollY);
    }
  ...
  render() {
    ...
    let {
      labelText
    } = (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.d)(el, rangeId);
    ...
    (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.e)(true, el, this.name, JSON.stringify(this.getValue()), disabled);
    ...
    }, ticks.map(tick => (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const renderKnob = (rtl, {
  ...
  return (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    "aria-valuenow": value
  }, pin && (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-pin",
    role: "presentation",
    part: "pin"
  }, pinFormatter(value)), (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    class: "range-knob",
    role: "presentation",
    part: "knob"
  }));
...
const ratioToValue = (ratio, min, max, step) => {
  ...
  return (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(min, value, max);
};

const valueToRatio = (value, min, max) => {
  return (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_4__.l)(0, (value - min) / (max - min), 1);
};
