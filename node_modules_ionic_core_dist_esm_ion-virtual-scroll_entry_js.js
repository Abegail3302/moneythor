...
const VirtualScroll = class {
  ...
  updateVirtualScroll() {
    ...
    (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.f)(this.readVS.bind(this));
    (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.c)(this.writeVS.bind(this));
  }
  ...
  updateCellHeight(cell, node) {
    ...
    if (node) {
      (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_2__.c)(node, update);
    } else {
      update();
    }
  }
  ...
  render() {
    ...
    }, this.renderItem && (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_1__.h)(VirtualProxy, {
      dom: this.virtualDom
